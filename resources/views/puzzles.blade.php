...
@section('content')
    <div class="page_wrap">
        <div class="banner-main" style="background-color: #e8d3b6 !important; height: 100vh;">
            <div class="vc_row wpb_row vc_row-fluid shape_divider_top-none shape_divider_bottom-none sc_layouts_row sc_layouts_row_type_normal scheme_dark" style="height: 100%;">
