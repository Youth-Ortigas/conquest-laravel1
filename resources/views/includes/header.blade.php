...
<header class="top_panel top_panel_custom_592 top_panel_custom_header-home with_bg_image kings_queens_inline_219517677" style="height: 100px;">
    <div
            ...
            <div class="vc_column-inner">
                <div class="wpb_wrapper">
                    <div class="sc_layouts_item">
                        <nav class="sc_layouts_menu sc_layouts_menu_default sc_layouts_menu_dir_horizontal menu_hover_fade hide_on_mobile hide_on_tablet inited"
        ...
        <div class="wpb_column vc_column_container vc_col-sm-3 vc_col-xs-12 sc_layouts_column sc_layouts_column_align_right hide_on_mobile hide_on_tablet" style="margin-top: 15px">
                    ...
                    <div class="sc_layouts_item">
                        ...
                        <a href="{{ $buttonLink }}" class="sc_button color_style_default sc_button_bordered sc_button_size_normal sc_button_with_icon sc_button_icon_left" id="btn-step-to-thy-conquest">
                            ...
                            <span class="sc_button_text">
                                <span class="sc_button_title" style="font-size: smaller !important">
                                    {{ $buttonText }}
                                </span>
                            </span>
                        </a>
