                                        ...
                                        <div id="sc_layouts_title_850083845" class="sc_layouts_title with_content without_image without_tint">
                                            <div class="sc_layouts_title_content">
                                                <div class="sc_layouts_title_title">
                                                    <h1 class="sc_layouts_title_caption">Second Puzzle</h1>
                                                </div>
                                                            ...
                                                            <div class="vc_column-inner">
                                                                <div class="wpb_wrapper">
                                                                    <div class="wpb_content_element vc_align_left wpb_content_element">
                                                                        <h3 style="margin: 9.15rem 0 25px 0;"> Enter The Hidden Key </h3>
                                                                        <h4> What Be Thy Answer? </h4>
                                                                        <label style="display: block; margin-top: 25px;">
                                                                            <input type="text" name="puzzle_code_2nd" placeholder="ENTER KEY"/>
                                                                            <button type="submit" style="margin-left: 15px;" id="btn-key-send"> Deliver Thy Reply </button>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                            </div>
